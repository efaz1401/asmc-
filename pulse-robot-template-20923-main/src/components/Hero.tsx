      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            <div
              className="company-chip mb-3 sm:mb-6 opacity-0 animate-fade-in"
              style={{ animationDelay: '0.1s' }}
            >
              <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-accent text-accent-foreground mr-2">
                01
              </span>
              <span>Manpower & Equipment</span>
            </div>
            ...
            >
              Providing skilled manpower and reliable equipment rental across
              Saudi Arabia.
            </p>
